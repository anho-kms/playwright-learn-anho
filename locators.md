...
| Items whose price contains "$15.99" | `.inventory_item.filter({has: .inventory_item_price, hasText: '$15.99'})` | `//div[@data-test="inventory-item"][.//div[@data-test="inventory-item-price" and contains(.,"15.99")]]` |
