...
export default class Env {
  ...
  static get SAUCE_WEB_URL(): string {
    return this.getEnvVar('SAUCE_WEB_URL');
  }

  static get SAUCE_USERNAME(): string {
    return this.getEnvVar('SAUCE_USERNAME');
  }

  static get SAUCE_PASSWORD(): string {
    return this.getEnvVar('SAUCE_PASSWORD');
  }
}